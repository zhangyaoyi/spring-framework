package org.springframework.aop.annotation.util;
...
public class LogUtil {
    ...
    @Pointcut("execution(public Integer org.springframework.aop.annotation.service.MyCalculator.*(Integer,Integer))")
